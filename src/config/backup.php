...
return [
    ...
    'backup' => [
        ...
        'destination' => [
             ...
             *
             * If backing up only database, you may choose gzip compression for dbdata dump and no compression at zip.
             *
         ...
         */
        'temporary_directory' => storage_path('database/schema/backup'),

        /*
         * The password to be used for archive encryption.
         * Set to `null` to disable encryption.
         */
        'password' => null, // BACKUP_ARCHIVE_PASSWORD
